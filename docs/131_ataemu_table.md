...
### SMART command table (0x1002fb84)
...
### SCE SECURITY command table (0x1002fc14)
...
| 36    | 0x24    | 2    | -1      | 0              | READ SECTOR(S) EXT               |
| 37    | 0x25    | 4    | 1       | 0              | READ DMA EXT                     |
| 38    | 0x26    | 7    | 1       | 0              | READ DMA QUEUED EXT              |
| 39    | 0x27    | 1    | 1       | 0              | READ NATIVE MAX ADDRESS EXT      |
| 40    | 0x00    | 0    | 0       | 0              | (Unimplemented)                  |
| 41    | 0x29    | 2    | -1      | 0              | READ MULTIPLE EXT                |
...
| 47    | 0x2F    | 2    | -1      | 0              | READ LOG EXT                     |
| 48    | 0x30    | 3    | -1      | 1              | WRITE SECTOR(S)                  |
| 49    | 0x00    | 0    | 0       | 0              | (Unimplemented)                  |
| 50    | 0x32    | 10   | 1       | 0              | DATA SET MANAGEMENT              |
| 51    | 0x00    | 0    | 0       | 0              | (Unimplemented)                  |
| 52    | 0x34    | 3    | -1      | 0              | WRITE SECTOR(S) EXT              |
| 53    | 0x35    | 4    | 1       | 0              | WRITE DMA EXT                    |
| 54    | 0x36    | 7    | 1       | 0              | WRITE DMA QUEUED EXT             |
| 55    | 0x37    | 1    | 1       | 0              | SET MAX ADDRESS EXT              |
| 56    | 0x38    | 3    | -1      | 0              | CFA WRITE SECTORS WITHOUT ERASE  |
| 57    | 0x39    | 3    | -1      | 0              | WRITE MULTIPLE EXT               |
